...
namespace calculator
{
    internal class Program
    {
        ...
        static void calculator()
        {
            ...
            double number1;
            double number2;
            onumber1(out number1);
            onumber2(out number2);
        ...
        private static double onumber1(out double cnumber1)
        {
            ...
            else
            {
                ...
                onumber1(out cnumber1);
                return cnumber1;
            }

        }
        private static double onumber2(out double cnumber2)
        {
